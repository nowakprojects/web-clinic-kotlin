...
VALUES (1, '2017-08-27', NULL, FALSE, NULL, '1996-08-23', 'kontakt.mateusznowak@gmail.com', 'Mateusz',
  ...
  (3, '2017-08-31', NULL, FALSE, NULL, '1934-11-11', 'test2@testowy.com', 'Test2',
      '$2a$10$3eWtzQGWcvNeZWNx3TYVAezxdOvbWPWP/2sIYjWrw9F21GBbZknD2', 'Testowy', TRUE, '223123123', 1),
...
INSERT INTO patient_card VALUES
  ...
  (6, '2017-01-01', NULL, FALSE, NULL, 2, 1),
  (7, '2017-01-01', NULL, TRUE , NULL, 2, 6);
...
INSERT INTO medical_visit VALUES
  ...
  (5, '2018-01-01', NULL, TRUE , NULL, FALSE, NULL, CURRENT_DATE, DATEADD('HOUR', 5, CURRENT_TIME), NULL, 1, 5),
  (6, '2018-01-01', NULL, FALSE, NULL, FALSE, NULL, CURRENT_DATE, DATEADD('HOUR', 5, CURRENT_TIME), NULL, 1, 6);
